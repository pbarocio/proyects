...
def generar_responsivas_word(df_responsivas, plantilla_path, output_dir):
    ...
    for idx, row in df_responsivas.iterrows():
        ...
        nombre_archivo = f"Responsiva CPU {row['empleado']} ({row['hostname']}).docx"
...
if __name__ == "__main__":
    ...
    plantilla_path = paths['dir_plantillas'] / "plantilla_cpu.docx"
    output_dir = paths['dir_responsivas'] / "Responsivas_CPU"
