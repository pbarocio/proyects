...
def aplicar_estilo_sb_admin():
    st.markdown("""
        <style>
            /* Fondo global del área de trabajo */
            .stApp {
            ...
            /* TARJETAS DE MÉTRICAS ESTILO SB ADMIN 2 */
            div[data-testid="stMetric"] {
                ...
                border-left: 5px solid #3b82f6 !important; /* Azul primario */
            }

            /* Bordes de estado por posición de columna */
            ...
            div[data-testid="column"]:nth-child(2) div[data-testid="stMetric"] {
                border-left-color: #10b981 !important; /* Asignados / Activos: Verde */
            }
            ...
            div[data-testid="column"]:nth-child(4) div[data-testid="stMetric"] {
                border-left-color: #f59e0b !important; /* Taller / Bajas: Ámbar */
            }

            /* Tipografía y Textos de Métricas */
            ...
            /* Contenedores de Gráficas, Formularios y Paneles */
